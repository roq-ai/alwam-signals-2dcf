...
-- AddForeignKey
ALTER TABLE "cloud_service" ADD CONSTRAINT "cloud_service_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "company" ADD CONSTRAINT "company_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "customer_service" ADD CONSTRAINT "customer_service_cloud_service_id_fkey" FOREIGN KEY ("cloud_service_id") REFERENCES "cloud_service"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
